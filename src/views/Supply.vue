...
<script>
    ...
    export default {
        ...
        methods: {
            getList() {
                let that = this;
                this.Axios.get("/lab2lab/v1/system/getlablist", {
                    type:that.type,
                    page:1,
                    limit:10
                }).then(function (res) {
                    console.log("获取服务方列表", res);
                    if (res.code == 200) {
                        that.List = res.data;
                    }
                })
...
<style lang="less" >
    ...
    .SupplyLeftBox {
        ...
        .icon-audited{
            background:url("../assets/imgs/btn-dshgys1.png") no-repeat;
            background-size: contain;
        }
        ...
        .active {
            ...
            .icon-audited{
                background:url("../assets/imgs/btn-dshgys2.png") no-repeat;
                background-size: contain;
            }
